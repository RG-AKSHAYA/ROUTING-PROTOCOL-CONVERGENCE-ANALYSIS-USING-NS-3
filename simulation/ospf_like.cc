...
NS_LOG_COMPONENT_DEFINE ("OspfLike");
...
int main (int argc, char *argv[])
{
    ...
    Ptr<OutputStreamWrapper> routingStream =
        Create<OutputStreamWrapper> ("ospf_routes.txt", std::ios::out);
    ...
    p2p.EnablePcapAll ("ospf_like");
    AnimationInterface anim ("ospf_animation.xml");
